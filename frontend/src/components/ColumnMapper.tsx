...
export const STOCK_RECEIPT_SUGGESTED_FIELDS: Record<string, string[]> = {
  SKU: ['SKU', 'CODE', 'PART NUMBER', 'PART NO', 'PART #', 'ITEM CODE', 'ITEM #', 'REFERENCE', 'MODEL', 'PRODUCT CODE'],
  PRODUCT_NAME: ['PRODUCT NAME', 'DESCRIPTION', 'ITEM DESCRIPTION', 'NAME', 'PRODUCT', 'TITLE', 'PARTICULARS'],
  BARCODE: ['BARCODE', 'BAR CODE', 'EAN', 'UPC', 'GTIN', 'ITEM BARCODE'],
  PURCHASE_PRICE: ['PURCHASE PRICE', 'COST', 'COST PRICE', 'BUY PRICE', 'BUYING PRICE', 'UNIT COST', 'PURCHASE RATE'],
  ...
  QUANTITY_ARRIVED: ['QUANTITY ARRIVED', 'QTY IN STOCK', 'QTY ARRIVED', 'QUANTITY', 'QTY', 'STOCK QTY', 'AMOUNT', 'RECEIVED QTY', 'STOCK', 'IN STOCK'],
  WAREHOUSE: ['WAREHOUSE', 'STORE', 'LOCATION', 'DESTINATION WAREHOUSE', 'WH', 'STORE TO'],
  QUANTITY_DESTINATION: ['QUANTITY AT DESTINATION', 'DESTINATION QTY', 'CURRENT STOCK', 'DEST QTY'],
  TOTAL: ['TOTAL', 'TOTAL COST', 'TOTAL AMOUNT', 'TOTAL PRICE', 'NET TOTAL'],
};
